    ...
    <main className="space-y-5">
      ...
      <section className="rounded-2xl border border-brand-100 bg-white p-5 shadow-xs">
        <div className="grid gap-3 md:grid-cols-4">
          <select aria-label="Select report program" className="h-11 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-700">
            <option>{reportMeta.programName}</option>
          </select>
          <select aria-label="Select report academic year" className="h-11 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-700">
            <option>{reportMeta.academicYear}</option>
          </select>
          <select aria-label="Select report ward scope" className="h-11 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-700">
