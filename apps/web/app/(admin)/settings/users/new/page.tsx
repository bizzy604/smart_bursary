        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 font-mono text-sm">
              <div className="text-xs uppercase tracking-wide text-gray-500">Temporary password</div>
              <div className="break-all">{result.temporaryPassword}</div>
            </div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 font-mono text-sm">
              <div className="text-xs uppercase tracking-wide text-gray-500">Email verify token</div>
