                ...
                {isLoading ? (
                  ...
                  filteredUsers.map((user) => (
                    <TableRow key={user.id}>
                      ...
                      <TableCell>{user.ward ? user.ward.name : <span className="text-gray-400">—</span>}</TableCell>
                      <TableCell>
                        <Badge variant={user.isActive ? "default" : "secondary"}>
                          {user.isActive ? "Active" : "Inactive"}
                        </Badge>
                      </TableCell>
                      <TableCell>{user.lastLoginAt ? formatShortDate(user.lastLoginAt) : <span className="text-gray-400">Never</span>}</TableCell>
