			...
			<Page size="A4" style={styles.page}>
				<View style={[styles.header, { borderColor: accentColor }]}>
					<View style={styles.headerRow}>
						...
						{params.logoDataUrl ? (
							<Image src={params.logoDataUrl} style={styles.logo} />
						) : null}
					</View>
				</View>
				...
				{params.qrCodeDataUrl ? (
					<View style={styles.qrBlock}>
						<Image src={params.qrCodeDataUrl} style={styles.qrImage} />
						<View>
							<Text style={styles.qrMeta}>Unique Serial No: {toText(params.reference)}</Text>
							<Text style={styles.qrMeta}>Scan to verify authenticity</Text>
						</View>
					</View>
				) : null}
