  ...
  <body>
    <div class="page">
      <header class="header" style="display:flex;justify-content:space-between;align-items:flex-start;">
        ...
        ${params.logoDataUrl ? `<img src="${escapeHtml(params.logoDataUrl)}" alt="County Logo" style="width:48px;height:48px;object-fit:contain;" />` : ''}
      </header>
      ...
      <div style="margin-top:14px;display:flex;align-items:center;gap:8px;">
        <img src="${escapeHtml(params.qrCodeDataUrl)}" alt="QR Code" style="width:64px;height:64px;" />
        <div style="font-size:11px;color:#4b5563;">
          <p style="margin:0;">Unique Serial No: ${escapeHtml(params.reference)}</p>
          <p style="margin:0;">Scan to verify authenticity</p>
        </div>
      </div>
      ` : ''}
